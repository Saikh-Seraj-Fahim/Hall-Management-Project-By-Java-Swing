...
public class Update extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					PreparedStatement ps = con.prepareStatement(
							"update StudentInformation set Name=?,Department=?,Hall_Clearance=?,Room_no=?,Home_District=? where id=?");
					ps.setString(1, name);
					ps.setString(2, department);
					ps.setString(3, hall_clearance);
					ps.setString(4, room_no);
					ps.setString(5, home_district);
					ps.setString(6, id);
					ps.executeUpdate();
	...
	public static void main(String[] args) {
		...
		f.setVisible(true);
		f.setTitle("Update Student Information");
